...
val eval_lv_with_footprint : ?spec:Spec.t -> BasicDom.Proc.t -> Cil.lval -> ItvDom.Mem.t -> Cil.location -> n_info:string -> BasicDom.PowLoc.t * Footprint.t * Footprints.t option
